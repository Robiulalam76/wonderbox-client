...
const BuyerReview = ({ product }) => {
  ...
  const handlePositiveClick = () => {
    const positiveReviews = reviews?.reviews.filter(
      (review) => review.isPositive
    );
  ...
  const handleNegativeClick = () => {
    const negativeReviews = reviews?.reviews.filter(
      (review) => !review.isPositive
    );
    ...
    <section className="bg-white min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:max-w-[900px]">
          ...
          <div className="md:col-span-2 grid grid-cols-1 gap-2">
            <div className="flex items-center gap-3">
              ...
              <Progress
                value={reviews?.ratingPercentages?.e}
                label="Completed"
                color="amber"
                size="lg"
            ...
            <div className="flex items-center gap-3">
              ...
              <Progress
                value={reviews?.ratingPercentages?.d}
                label="Completed"
                color="amber"
                size="lg"
                className="w-full md:w-[476px]"
            ...
            <div className="flex items-center gap-3">
              ...
              <Progress
                value={reviews?.ratingPercentages?.c}
                label="Completed"
                color="amber"
                size="lg"
                className="w-full md:w-[476px]"
            ...
            <div className="flex items-center gap-3">
              ...
              <img className="w-5" src={starG} alt="" />
              <Progress
                value={reviews?.ratingPercentages?.b}
                label="Completed"
                color="amber"
                size="lg"
                className="w-full md:w-[476px]"
            ...
            <div className="flex items-center gap-3">
              ...
              <img className="w-5" src={starG} alt="" />
              <Progress
                value={reviews?.ratingPercentages?.a}
                label="Completed"
                color="amber"
                size="lg"
                className="w-full md:w-[476px]"
      ...
      <div>
        ...
        <div className="grid lg:grid-cols-2 gap-6 mt-6">
                ...
                <div key={i} className="rounded-md border">
                  ...
                  <div className="flex flex-col gap-2 p-2 md:py-4 md:px-6">
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        className={`rounded-2xl text-xs py-1 w-fit px-1
                                    ${
                                      review?.isPositive
                                        ? "bg-green-300"
                                        : "bg-yellow-200"
                      ...
                      >
                        {review?.isPositive ? "Positive" : "Nagetive"}
                      </Button>
                    </div>
          ...
          <SendReview product={product} refetch={refetch} />
        </div>
      </div>

      <UpdateReviewModal
        open={reviewData}
        setOpen={setReviewData}
        refetch={refetch}
      />
      <DeleteModal
        open={reviewDelete}
        close={setReviewDelete}
