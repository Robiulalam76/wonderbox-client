    ...
    <footer className="relative w-full bg-white">
      <div className="max-w-primary px-4 mx-auto pt-10">
        <div className="grid md:grid-cols-3 lg:grid-cols-7 gap-4 gap-y-6 md:gap-y-16 mb-8">
          <div className="lg:col-span-2">
            <img
              ...
              src="https://w7.pngwing.com/pngs/266/755/png-transparent-webflow-blue-w-logo-icon-tech-companies.png"
              alt="footerImage"
            />
            <p className="text-gray-500 text-center md:text-left mb-4">
              Enim enim integer quam volutpat, a ut fames. Ornare sem egestas
              tincidunt vitae at nisi ultricies arcu.
            </p>

            <h1 className="text-black font-bold text-xl text-center md:text-left mb-4">
              Follow Us
            </h1>
          ...
          <div>
            <h1 className="text-black font-bold text-center md:text-left mb-4 md:mb-6">
              Customer Services
            </h1>
          ...
          <div>
            ...
            <div className="text-gray-500 text-left font-normal flex flex-col justify-start items-center md:items-start gap-3">
              <Link to="/about-us" className="hover:text-primary duration-150">
                About
              </Link>
              <Link to="/contact" className="hover:text-primary duration-150">
                Contact us
              </Link>
        ...
        <div className="flex w-full flex-col items-center justify-center border-t border-blue-gray-300 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear}{" "}
            <a href="https://material-tailwind.com/">Wonderbox</a>. All Rights
            Reserved.
          </Typography>
