    ...
    return (
        <Drawer
            ...
            <ul className="relative flex flex-col overflow-y-auto overflow-x-hidden cursor-pointer">
                ...
                <Link to="/my-account">
                    <span onClick={() => dispatch(setOpenProfileDrawer(false))} className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                        <span className="inline-flex justify-center items-center ml-4">
