    ...
    return (
        <div className='max-w-primary px-4 mx-auto min-h-screen'>
            <div className='relative' >
                <img className='w-full h-36 md:h-72 object-fill' src="https://t3.ftcdn.net/jpg/02/62/18/46/360_F_262184611_bXhmboL9oE6k2ILu4qXxNWFhNJCEbTn2.jpg" alt="" />

                <div className='flex items-end gap-2 md:gap-6 absolute -bottom-12 md:-bottom-20 left-6 md:left-12 z-30'>
                    <Avatar className='w-20 h-20 md:w-32 md:h-32 bg-white border border-black' src={data?.logo} />
                    <div className='md:mb-4' >
                        <Typography className="md:text-xl font-bold" >{data?.name}</Typography>
